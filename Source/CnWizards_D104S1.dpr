...
uses
  ...
  CnFastCodeWizard in 'IdeEnhancement\CnFastCodeWizard.pas',
  ...
  CnFormEnhancements in 'IdeEnhancement\CnFormEnhancements.pas' {CnFormEnhanceConfigForm},
  CnFlatToolbarConfigFrm in 'IdeEnhancement\CnFlatToolbarConfigFrm.pas' {CnFlatToolbarConfigForm},
  CnPaletteEnhancements in 'IdeEnhancement\CnPaletteEnhancements.pas',
  CnPaletteEnhanceFrm in 'IdeEnhancement\CnPaletteEnhanceFrm.pas' {CnPalEnhanceForm},
  CnCompFilterFrm in 'IdeEnhancement\CnCompFilterFrm.pas' {CnCompFilterForm},
  ...
  CnCpuWinEnhancements in 'IdeEnhancement\CnCpuWinEnhancements.pas',
  CnCpuWinEnhanceFrm in 'IdeEnhancement\CnCpuWinEnhanceFrm.pas' {CnCpuWinEnhanceForm},
  CnObjInspectorEnhancements in 'IdeEnhancement\CnObjInspectorEnhancements.pas' {CnObjInspectorConfigForm},
  CnObjInspectorCommentFrm in 'IdeEnhancement\CnObjInspectorCommentFrm.pas' {CnObjInspectorCommentForm},
  ...
  CnWinTopRoller in 'IdeEnhancement\CnWinTopRoller.pas' {CnTopRollerForm},
  ...
  CnVerEnhancements in 'IdeEnhancement\CnVerEnhancements.pas',
  CnVerEnhanceFrm in 'IdeEnhancement\CnVerEnhanceFrm.pas' {CnVerEnhanceForm},
  ...
  CnUnitsDependency in 'SimpleWizard\CnUnitsDependency.pas',
  CnUnitsDependencyFrm in 'SimpleWizard\CnUnitsDependencyFrm.pas',
  ...
  CnIdeEnhanceMenu in 'IdeEnhancement\CnIdeEnhanceMenu.pas',
