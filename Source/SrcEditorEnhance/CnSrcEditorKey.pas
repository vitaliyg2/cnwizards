...
{$ENDIF}
    procedure EditControlKeyDown(Editor: TCnEditorObject; Key, ScanCode: Word; Shift: TShiftState;
      var Handled: Boolean);
    procedure EditControlKeyUp(Editor: TCnEditorObject; Key, ScanCode: Word; Shift: TShiftState;
      var Handled: Boolean);
...
procedure TCnSrcEditorKey.EditControlKeyDown(Editor: TCnEditorObject; Key, ScanCode: Word;
...
procedure TCnSrcEditorKey.EditControlKeyUp(Editor: TCnEditorObject; Key, ScanCode: Word; Shift: TShiftState;
  var Handled: Boolean);
begin
